...
const at_command_handler_t at_command_init_table[] = {
    ...
    {"AT+ALIYUNCN1=cn-shanghai,k1zh353PPIK,Device_my_test,4f666eea64245f502a2de9279df808b8,180,1\r\n", "OK", 1000},                            // 设置阿里云参数
	{"AT+ALIYUNMTPC1=OFF\r\n", "OK", 1000},
    {"AT+ALIYUNSUB1=/sys/k1zh353PPIK/Device_my_test/thing/service/property/set,0\r\n", "OK", 1000},                           // 设置订阅主题
	{"AT+ALIYUNPUB1=/sys/k1zh353PPIK/Device_my_test/thing/event/property/post,0,0\r\n", "OK", 1000},   						//设置发布主题
...
/**
 * @brief 设置ALIYUN参数，如代理地址、端口和客户端ID
 *
...
void yundtu_process(void)
{
    ...
    case YUNDTU_READ_RESET_INFO:
        ...
        {
            if (yundtu_tick_cnt >= 30000)   // 超过30秒未读到复位信息，复位设备
            {
