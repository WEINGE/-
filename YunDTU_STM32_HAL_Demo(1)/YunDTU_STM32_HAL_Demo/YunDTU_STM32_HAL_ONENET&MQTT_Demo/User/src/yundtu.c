...
const at_command_handler_t at_command_init_table[] = {
    ...
    {"AT+E=OFF\r\n", "OK", 1000},																//关闭回显			
    {"AT+WKMOD1=CLOUD\r\n", "OK", 1000},										//设置通道一为连云模式
    {"AT+CLOUD1=ONENET\r\n", "OK", 1000},															//设置为ONENET服务器 
    {"AT+ONENETTP1=USER\r\n", "OK", 1000},									//设置为用户注册
    {"AT+ONENETCN1=JyCaN5mktG,Device_demo,WWZNdE9uenJYeXdxTGx2S3pSdlU5bm5PaFBYaVMxR2k=,180,1\r\n", "OK", 1000},															//配置ONENET参数
    {"AT+ONENETMTPC1=OFF\r\n", "OK", 1000},	//关闭多主题模式
    {"AT+ONENETSUB1=$sys/JyCaN5mktG/Device_demo/thing/property/post/reply,0\r\n", "OK", 1000},							//设置订阅主题
    {"AT+ONENETPUB1=$sys/JyCaN5mktG/Device_demo/thing/property/post,0,0\r\n", "OK", 1000},									//设置发布主题
...
/**
 * @brief 设置onenet参数，如代理地址、端口和客户端ID
 *
