 ...
 *****************************************************************************************
 */
/**@brief 4G protocol sensor data structure (water level detection). */
typedef struct
{
...
/**@brief 4G parameter settings structure (water level detection). */
typedef struct
{
 ...
 * 
 * 以更高频率检测水位阈值，提升灵敏度。当检测到水位超过阈值时立即进入水浸模式。
 * 不存储数据，不写Flash，功耗影响小。
 *****************************************************************************************
 */
